...
p = [Player((GAME_WIDTH / 2, GAME_HEIGHT / 2 - PLAYER_GAP * GRID_SIZE), BLUE, DOWN, INITIAL_LENGTH), Player((GAME_WIDTH / 2, GAME_HEIGHT / 2 + PLAYER_GAP * GRID_SIZE), RED, UP, INITIAL_LENGTH)]
